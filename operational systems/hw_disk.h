...
// funcao que envia comandos para o disco
int disk_cmd (int cmd, int block, void *buffer) ;

/*
 IMPORTANTE: no caso de operacoes assincronas, a chamada acima apenas "agenda"
 os pedidos de operacao e retorna imediatamente. Quando a operacao solicitada
 for concluida, o disco ira gerar um sinal SIGUSR1, que deve ser recebido e
 tratado pelo gerenciador de disco, para acordar a tarefa que solicitou a
 operação.
*/
