/* Cauê Oliveira Gobbo Rodrigues - 2016

Estruturas de dados em C. Pilha, Fila e Lista */
...
/* Estrutura de dados com padrão "lifo" (Last in first out), seu manejo consiste em inclusão e remoção de conteúdo, verificação de pilha vazia e alocação e desalocação */
...
/* Estrutura de dados com padrão "fifo" (First in first out), seu manejo consiste em inclusão e remoção de conteúdo, verificação de fila vazia e alocação e desalocação */
...
/* Estrutura de armazenamento complexa, sua estrutura permite diversas operações tais como inversão, ordenação, seleção, busca, entre outras. O símbolo '+' que está inserido em alguns comentários dos headers das funções significa que há mais informações comentadas junto à função propriamente dita */
